export default function ProcessBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 z-0" aria-hidden="true">
      ...
      <div
        className="absolute -top-[18%] -left-[10%] h-[70%] w-[52%] rounded-full"
        style={{
          background:
            "radial-gradient(circle, rgba(225,6,0,0.17) 0%, rgba(225,6,0,0.05) 42%, transparent 70%)",
        }}
      />

      <div
        className="absolute -bottom-[12%] -right-[6%] h-[62%] w-[50%] rounded-full"
        style={{
          background:
            "radial-gradient(circle, rgba(122,0,0,0.21) 0%, rgba(122,0,0,0.07) 45%, transparent 70%)",
        }}
      />
    </div>
  );
