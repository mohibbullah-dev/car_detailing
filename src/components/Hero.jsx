        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="h-16 px-8 rounded-2xl bg-blue-600 text-white text-[11px] font-black uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-blue-500 transition-all shadow-glow-blue active:scale-95">
