...
//   const { mutateAsync, isPending, error } = useCreatePortfolio();
...
//             You are not logged in. Upload requires an admin token.
//             <div className="mt-2 text-xs text-amber-700">
//               Login first (create an /admin/login page or store token in
//               localStorage).
//             </div>
//           </div>
//         ) : null}
...
//               className="mt-2 w-full rounded-xl border border-zinc-200 px-3 py-2"
//               placeholder="e.g. Emergency,Leak Fix"
//             />
...
//               Upload failed. Most common reasons:
//               <ul className="mt-2 list-disc pl-5 text-xs text-red-600">
//                 <li>Missing/invalid admin token (401)</li>
//                 <li>Backend not running / wrong API base URL</li>
//                 <li>Cloudinary issue / file too large</li>
//               </ul>
//             </div>
//           ) : null}
//         </form>
